...
export interface PiBridge {
  ...
  sessionsList(force?: boolean, summary?: boolean): Promise<unknown>;
  sessionsSearch(query: string): Promise<{ status: number; body?: unknown }>;
  sessionsGet(id: string, options?: { deferThinking?: boolean; deferMedia?: boolean; tail?: number; force?: boolean; tree?: "summary" }): Promise<unknown>;
