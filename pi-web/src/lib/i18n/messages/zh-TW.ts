...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.shellToolDescription": "在 bash 与 PowerShell 之间切换命令执行工具（仅 Windows）。",
    "settings.usePowerShell": "使用 PowerShell",
    "settings.projectRequired": "打开一个项目后可用。",
    "skills.scope.global": "全局",
    "skills.scope.project": "项目",
    "skills.scope.path": "路径",
    "agents.close": "关闭",
    "agents.builtInTitle": "内置智能体",
    "agents.builtInDescription": "启用后，当前会话可派生可检查的子智能体。修改需要重载会话。",
    "agents.reloadRequired": "需要重载会话以应用更改",
    "agents.reloadSession": "重载会话",
    "agents.reloading": "正在重载…",
    "agents.loading": "正在加载智能体…",
    "agents.new": "新建智能体",
    "agents.empty": "尚无智能体。创建一个以委派子任务。",
    "agents.saveScope": "保存范围",
    "agents.name": "名称",
    ...
    "agents.thinking": "思考等级",
    "agents.maxTurns": "最大轮数",
    "agents.inherit": "继承",
    "agents.enable": "启用",
    "agents.disable": "停用",
    "agents.builtinPath": "内置路径",
    ...
    "agents.overridden": "被更低范围的同名智能体覆盖",
    "subagent.open": "打开智能体会话",
    "agentSwitcher.current": "当前会话",
    "agentSwitcher.main": "主会话",
    "agentSwitcher.noMatches": "没有匹配的智能体会话",
    "agentSwitcher.runningCount": "{count} 个运行中",
    "agentSwitcher.search": "搜索智能体会话…",
    "agentSwitcher.subagent": "智能体",
    "agentSwitcher.title": "智能体",
    "agentSwitcher.count": "{count} 个智能体",
    ...
    "system.tools": "工具定義",
    "system.toolsCount": "已啟用 {count} 個",
    "system.toolsLoad": "工具定義尚未載入",
    "system.toolsLoading": "正在載入工具定義…",
    "system.noTools": "沒有啟用的工具",
    "system.parameters": "參數",
    "system.parameterCount": "{count} 個參數",
    "system.noParameters": "無參數",
    "system.required": "必填",
    "system.optional": "可選",
    "system.allowedValues": "可選值",
    "system.defaultValue": "預設值",
    "system.guidelines": "提示詞規則",
    "system.label": "系統",
    "session.info": "工作階段資訊",
    "session.name": "名稱",
    "session.file": "工作階段檔案",
    ...
    "workspace.addModels": "點選底部的「模型」按鈕新增模型",
...
"sidebar.searchSessions": "搜尋所有對話...",
    ...
    "sidebar.sessionSearchFailed": "無法搜尋對話",    "sidebar.changedFiles": "{count} 個已變更檔案",
    "sidebar.loading": "載入中...",
    ...
    "chat.commandClone": "將目前分支複製為獨立新會話",
    "chat.compacted": "已壓縮",
