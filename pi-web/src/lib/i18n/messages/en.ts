...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "agentSwitcher.current": "Current session",
    "agentSwitcher.main": "Main session",
    "agentSwitcher.noMatches": "No matching agent sessions",
    "agentSwitcher.runningCount": "{count} running",
    "agentSwitcher.search": "Search agent sessions…",
    "agentSwitcher.subagent": "Agent",
